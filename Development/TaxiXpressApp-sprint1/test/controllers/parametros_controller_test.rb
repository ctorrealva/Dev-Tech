...
class ParametrosControllerTest < ActionController::TestCase
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post :create, parametro: { FechaVenceRevTec: @parametro.FechaVenceRevTec, FechaVenceSoat: @parametro.FechaVenceSoat, IdParametro: @parametro.IdParametro, Placa: @parametro.Placa }
    end
  ...
  test "should update parametro" do
    patch :update, id: @parametro, parametro: { FechaVenceRevTec: @parametro.FechaVenceRevTec, FechaVenceSoat: @parametro.FechaVenceSoat, IdParametro: @parametro.IdParametro, Placa: @parametro.Placa }
    assert_redirected_to parametro_path(assigns(:parametro))
  end
