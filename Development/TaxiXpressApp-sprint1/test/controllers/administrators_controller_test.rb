...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { first_name: @administrator.first_name, id_number: @administrator.id_number, last_name: @administrator.last_name, user_id: @administrator.user_id }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { first_name: @administrator.first_name, id_number: @administrator.id_number, last_name: @administrator.last_name, user_id: @administrator.user_id }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
