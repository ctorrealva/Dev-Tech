...
class VehiculosControllerTest < ActionController::TestCase
  ...
  test "should create vehiculo" do
    assert_difference('Vehiculo.count') do
      post :create, vehiculo: { FechaVenceRevTec: @vehiculo.FechaVenceRevTec, FechaVenceSoat: @vehiculo.FechaVenceSoat, IdVehiculo: @vehiculo.IdVehiculo, Placa: @vehiculo.Placa }
    end
  ...
  test "should update vehiculo" do
    patch :update, id: @vehiculo, vehiculo: { FechaVenceRevTec: @vehiculo.FechaVenceRevTec, FechaVenceSoat: @vehiculo.FechaVenceSoat, IdVehiculo: @vehiculo.IdVehiculo, Placa: @vehiculo.Placa }
    assert_redirected_to vehiculo_path(assigns(:vehiculo))
  end
