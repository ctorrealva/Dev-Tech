...
class TipoPagosControllerTest < ActionController::TestCase
  ...
  test "should create tipo_pago" do
    assert_difference('TipoPago.count') do
      post :create, tipo_pago: { CodigoTipoPago: @tipo_pago.CodigoTipoPago, Descripcion: @tipo_pago.Descripcion }
    end
  ...
  test "should update tipo_pago" do
    patch :update, id: @tipo_pago, tipo_pago: { CodigoTipoPago: @tipo_pago.CodigoTipoPago, Descripcion: @tipo_pago.Descripcion }
    assert_redirected_to tipo_pago_path(assigns(:tipo_pago))
  end
