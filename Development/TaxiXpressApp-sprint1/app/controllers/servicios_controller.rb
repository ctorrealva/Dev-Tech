class ServiciosController < ApplicationController
  ...
  private
    ...
    def servicio_params
      params.require(:servicio).permit(:IdServicio, :cliente_id, :conductor_id, :vehiculo_id, :tipopago_id, :Origen, :Destino, :FechaHora, :estadoservicio_id, :Puntaje, :Comentario, :Monto)
    end
end
